        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div>
                        <h1 class="text-3xl font-black tracking-tight text-slate-900">Order Summary</h1>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            <div v-for="(items, groupName) in groupedItems" :key="groupName" class="border-b border-slate-100 last:border-0 pb-4 last:pb-0">
                                ...
                                <div class="space-y-2">
                                    <div v-for="item in items" :key="item.id" class="flex justify-between items-center py-2">
                                        <div class="flex items-center gap-3">
                                ...
                                <div class="space-y-3">
                                    <div class="flex gap-2">
                                        <input 
                                            ...
                                            class="flex-1 rounded-xl border-slate-200 bg-slate-50 focus:bg-white focus:border-slate-900 transition-all"
